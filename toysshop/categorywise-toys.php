...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM tbltoys where category='$cid'");
    ...
    $query=mysqli_query($con,"select tbltoys.id as pid,tbltoys.ToyImage1,tbltoys.ToyName,tbltoys.ToyPriceBeforeDiscount,tbltoys.ToyPriceAfterDiscount from tbltoys where category='$cid' order by pid desc LIMIT $offset, $total_records_per_page");
$cnt=1;
                                    ...
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          ...
                                          <div class="grid-price mt-2">
                                             <span class="money ">$<?php echo htmlentities($row['ToyPriceBeforeDiscount']);?></span>
                                          </div>
                                       </div>
...
<h3 align="center" style="color:red;padding-left: 50px;">No Toys found in this category</h3>
