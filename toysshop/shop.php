...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $query=mysqli_query($con,"select tbltoys.id as pid,tbltoys.ToyImage1,tbltoys.ToyName,tbltoys.ToyPriceBeforeDiscount,tbltoys.ToyPriceAfterDiscount from tbltoys order by pid desc LIMIT $offset, $total_records_per_page ");
$cnt=1;
