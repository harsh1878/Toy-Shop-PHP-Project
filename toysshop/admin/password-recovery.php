...
<html lang="en">
    <head>
        ...
        <title>Toys Shops | Password Recovery </title>
...
return true;
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Toy Shops | Password Recovery</h3></div>
                                    <div class="card-body">
 ...
 <div class="form-floating mb-3">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="index.php">Signin</a>
