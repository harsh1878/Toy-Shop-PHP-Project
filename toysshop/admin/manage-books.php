...
echo "<script>window.location.href='manage-tblbooks.php'</script>";
}
...
<html lang="en">
    <head>
        ...
        <title>Toys Store | Manage Books</title>
...
?>  
                                ...
                                <tr>
                                            ...
                                            <a href="manage-tblbooks.php?id=<?php echo $row['pid']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
