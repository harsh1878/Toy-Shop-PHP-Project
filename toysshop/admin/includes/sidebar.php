                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading">Toys Management</div>
            ...
            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#subcat" aria-expanded="false" aria-controls="subcat">
                            ...
                            <div class="collapse" id="brand" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="manage-brand.php">Manage</a>
                                </nav>
                            </div>
...
<!--- Products --->
            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#product" aria-expanded="false" aria-controls="product">
                            ...
                            <div class="collapse" id="product" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="add-toys.php">Add</a>
                                    <a class="nav-link" href="manage-toys.php">Manage</a>
                                </nav>
                            </div>
...
<a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#product1" aria-expanded="false" aria-controls="product1">
                            ...
                            <div class="collapse" id="product1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                     ...
                                     <a href="all-reviews.php" class="nav-link">All Reviews</a>
                                     <a href="new-reviews.php" class="nav-link">New Reviews</a>
                                     <a href="approved-reviews.php" class="nav-link">Accept Reviews</a>
                                     <a href="unapproved-reviews.php" class="nav-link">Reject Reviews</a>
                            ...
                            <div class="collapse" id="product2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                     ...
                                     <a href="readenq.php" class="nav-link">Read Enquiry</a>
                                     <a href="unreadenq.php" class="nav-link">Unread Enquiry</a>
