...
<html lang="zxx">
   <head>
      <title>Toys Shop | Wishlist </title>
      <!--meta tags -->
                     ...
                     <div class="checkout-right">
                        ...
                        <table class="timetable_sub">
                           ...
                           <tbody>
                              <?php
$uid=$_SESSION['id'];
$ret=mysqli_query($con,"select tbltoys.ToyName as pname,tbltoys.ToyName as proid,tbltoys.ToyImage1 as pimage,tbltoys.ToyPriceAfterDiscount as pprice,wishlist.productId as pid,wishlist.id as wid,tbltoys.ToyPriceBeforeDiscount from wishlist join tbltoys on tbltoys.id=wishlist.productId where wishlist.userId='$uid'");
$cnt=1;
...
?>
                              <tr class="rem1">
                                 ...
                                 <td class="invert">
                                    <div class="quantity">
                                       <div class="quantity-select">
                                          ...
                                          <div class="entry value"><span><?php echo htmlentities('1');?></span></div>
                                 ...
                                 <td class="invert">₹<?php echo htmlentities(1*$row['pprice']);?></td>
                                 <td class="invert">
...
<a href="shop.php" class="btn-upper btn btn-warning">Continue Shopping</a>
                ...
                <?php } else{ ?>
                <tr>
                    <td style="font-size: 18px; font-weight:bold " colspan="7">Your wishlist is Empty.&nbsp;
<a href="shop.php" class="btn-upper btn btn-warning">Continue Shopping</a>
                    </td>
